...
export const demoTaskResources: ResourcesByKey = {
  ...
  "demo-japanese-t5": R("demo-japanese-t5", [
    ["article", "Tofugu Learn Japanese guide", "A curated roadmap for building practical Japanese vocabulary alongside reading, writing, speaking, and listening skills.", "https://www.tofugu.com/learn-japanese/"],
  ]),

  "demo-game-t1": R("demo-game-t1", [
    ["documentation", "Your first Godot 2D game", "A guided first project that keeps the core game loop small and finishable.", "https://docs.godotengine.org/en/stable/getting_started/first_2d_game/index.html"],
  ...
  "demo-game-t2": R("demo-game-t2", [
    ...
    ["practice", "Godot first 2D game", "Apply movement in a small playable project and iterate on how it feels.", "https://docs.godotengine.org/en/stable/getting_started/first_2d_game/index.html"],
  ]),
  "demo-game-t3": R("demo-game-t3", [
    ...
    ["practice", "Your first Godot 2D game", "Block out a playable level before adding polish or final art.", "https://docs.godotengine.org/en/stable/getting_started/first_2d_game/index.html"],
  ]),
